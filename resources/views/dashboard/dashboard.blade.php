                        ...
                        <div class="card card-stats card-info">
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="icon-big text-center">
                                            <i style="font-size: 30px" class="fa-brands fa-product-hunt"></i>
                                        </div>
                                    </div>
                                    <div class="col-9 d-flex align-items-center">
                                        <div class="numbers">
                                            <p class="card-category">Quantity Sold</p>
                                            <h4 class="card-title">290</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-primary">
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-3">
                                        <div class="icon-big text-center">
                                            <i style="font-size: 30px" class="fa-solid fa-arrow-up-wide-short"></i>
                                        </div>
                                    </div>
                                    <div class="col-9 d-flex align-items-center">
                                        <div class="numbers">
                                            <p class="card-category">Total Profrt</p>
                                            <h4 class="card-title">$290</h4>
                                        </div>
                                    </div>
                                </div>
